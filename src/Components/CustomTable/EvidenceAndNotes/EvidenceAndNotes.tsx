...
const EvidenceAndNotes = ({ row }: { row: TableData }): JSX.Element => {
    ...
    return (
        <>
            <TableCell align="right"><TextBox defaultValue={evidence} active={active} setActive={setActive} handleOnChange={(e) => handleOnChange(e, 'evidence')} /></TableCell>
            <TableCell align="right"><TextBox defaultValue={notes} active={active} setActive={setActive} handleOnChange={(e) => handleOnChange(e, 'notes')} /></TableCell>
        </>
    )
}
