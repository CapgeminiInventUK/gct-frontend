        ...
        <div className={styles.container}>
            ...
            <div className={styles.form}>
                <div className={styles.formItem}>
                    <Typography variant="h5" color={emailError ? 'red' : 'black'}>Email</Typography>
                    <TextField onChange={(e) => setEmail(e.target.value)} value={email} />
                </div>
                <div className={styles.formItem}>
                    <Typography variant="h5" color={gradeError ? 'red' : 'black'}>Current grade</Typography>
            ...
            <Button variant="contained" onClick={submitForm}><Typography variant="h6">Login</Typography></Button>
        </div>
    )
}
